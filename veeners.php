...
<section class="single-header">
        <div class="grid">
            <div class="bg-here">
                <div class="inr">
                    <div class="headings">
                        <h2 class="clr-blue3 min-b">Veeners</h2>
                        <h1 class="clr-blue2 most-b">Explained</h1>
                    </div>
                    <div class="line"></div>
                    <p class="mb-0">Porcelain veneers are a popular solution offered in modern dentistry, providing a brilliant way to transform and enhance your smile. These wafer-thin, bespoke ceramic shells are carefully crafted to fit over the front surface of your teeth, improving their appearance in a way that looks natural, feels comfortable, and stands the test of time.</p>
                    <br>
                    <p>Porcelain, being a durable and highly aesthetic material, has been meticulously chosen for the task. It beautifully mimics the light-reflecting properties of natural tooth enamel and is resistant to staining. This ensures that your smile retains its lustre for many years, even with consumption of tea, coffee, and other staining foods and drinks that are integral to the British way of life.</p>
                </div>
            </div>
            <div class="img-div">
                <img src="assets/a-images/header (7).webp" alt="">
        ...
        <div class="wrap">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="headings">
                            <h3 class="clr-blue3 min-b">What are </h3>
                            <h2 class="clr-blue2 most-b">Veeners?</h2>
                        </div>
                        <p>Veneers are a versatile solution. Whether you wish to remedy a single tooth that's slightly out of alignment, correct a chipped tooth, or transform your entire smile to cover discolouration or uneven spacing, porcelain veneers are a fantastic option. </p>
                        <p>The veneer fitting process is straightforward and requires minimal alterations to your natural teeth. After an initial consultation and detailed impressions of your teeth, your personalised veneers are skilfully crafted in a dental laboratory. Once ready, these are bonded to your teeth using a special adhesive, creating a seamless blend with your existing teeth.</p>
                        <div class="demo-gallery">
                            <ul id="lightgallery">
                                ...
                                data-src="assets/a-images/single-o (5).webp" data-lg-id="d3073da3-6eff-42db-b87a-3591172862f1">
                                    <a href="">
                                        <img class="img-responsive" src="assets/a-images/single-o (5).webp">
                                ...
                                data-src="assets/a-images/single-two (5).webp" data-lg-id="43130779-7c33-4a3e-8a36-7d71eda5f995">
                                    <a href="">
                                        <img class="img-responsive" src="assets/a-images/single-two (5).webp">
                                        <div class="demo-gallery-poster">
                                            <img src="https://sachinchoolur.github.io/lightgallery.js/static/img/zoom.png">
                                        </div>
                                    </a>
                                ...
                                <li data-responsive="https://sachinchoolur.github.io/lightgallery.js/static/img/13-375.jpg 375, https://sachinchoolur.github.io/lightgallery.js/static/img/13-480.jpg 480, https://sachinchoolur.github.io/lightgallery.js/static/img/13.jpg 800"
                                 data-src="assets/a-images/single-three (5).webp" data-lg-id="df1f539c-b61e-4f64-a562-6ae4939164c9">
                                    <a href="">
                                        <img class="img-responsive" src="assets/a-images/single-three (5).webp">
                                        <div class="demo-gallery-poster">
                                            <img src="https://sachinchoolur.github.io/lightgallery.js/static/img/zoom.png">
                                        </div>
                                    </a>
                        ...
                        <!-- <p>With good oral hygiene and regular check-ups, porcelain veneers can last for many years, making them a long-term investment in the overall appearance of your teeth. For those looking for a radiant, youthful, and balanced smile, porcelain veneers are truly a transformative and premium choice in cosmetic dentistry.</p> -->
                        <h3 class="clr-blue3 min-b" style="font-size: 24px;">Why choose veneers?</h3>
                        <ul>
                            <li>Cover a stained tooth or discoloured teeth</li>
                            <li>Correct misshapen or chipped teeth</li>
                            <li>Mimic the look of natural teeth</li>
                            <li>Made to match the precise shade of your teeth</li>
                            <li>Porcelain veneers are highly stain-resistant</li>
                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                ...
                                <!--                                    <h3>Veeners Preparation &</h3>-->
                                <!--                                    <h2>How it's being done</h2>-->
                                <!--                                </div>-->
                                <p style="font-size: 18px">At Russell Street Dental Practice, we are passionate about crafting smiles that reflect the confidence and personality of our patients. If you're considering porcelain bonding, we invite you to book a consultation with us. We would be more than happy to discuss whether this treatment might be the right option for you.</p>
                            </div>
                            <div class="col-lg-5">
                        ...
                        <!-- <p>At our dental practice, we pride ourselves on ensuring each veneer is carefully customised to suit the shape, size and colour of your teeth. This personalised approach ensures a natural-looking result that blends seamlessly with your smile, enhancing your confidence and adding a touch of brilliance to your everyday interactions. </p> -->
                    </div>
                    <div class="col-lg-5">
    ...
    <div class="cal-mail d-flex align-items-center gap-2">
        ...
        <form action="" class="needs-validation" id="contactForm">
            ...
            <div class="col-md-12 mb-3 d-flex justify-content-center">
                ...
                <input type="hidden" id="g-recaptcha-response" name="g-recaptcha-response" value="0cAFcWeA6tCWT94NF4VQr4VIGjWKOHGYofCxyTeQ89xODvQm5kRQ2Zb3d0uvkTk-PWZOcIDaEWlwTp2rn9fu64Bm25XRtYY0LlGEWPP6ypjdWngXGaRNkmD7-knQU6bV2oH4yKkXJ5x_aYCSCKFKvpi7mBGdn6u-wQlbgUhqxhlK7Qf3lpRQgbQAIKZzA-0oBDwNHDQ9JtQT9wKn29LQP5mlq6xoeWKzL3xsrJYaqPY4A77xv-QRP11dAV9M752R6G_01bUfIlMup8Pajjn4RdsLb7gI_rvkoN1xPJDNyLYH7iie5mbkgdGGkP7xwRZu40bdx1fYjqVWgZ_s_dN7ZS3Xr8IiLrpfy1N87TpEVE6fIBsPFQIjiC_o1FEMkmKPKSOT7GQS4cpYerkJVCXk06pBdxmXaYWMR1QhKF-52CB6_eT29CdURgKr-awibt5A6IYdBd1A34pNVea4Y-KfrQ9lh7Y6Q863xOYQ3oCxiyf_unNBVpf8nXE5M5NSHwn4Z9N-frN7Rvi4trvSN1aG1TF2E9vDICgPkh2ydMy1LlKxTZhEnqPd44GMAivEQZavaZtaMSB_6W1DnQLnSoO5B-joQiQmmPoVdaRPVM9S-MZsH_MA28sxGio9veSQdu5bCL0od_7_H2n7CbedzK9dkLvNWnKiO2MVjIcHM9BmLnihZjY-QJPB0e1KJkzckzsHICmT48wIj-MGUq3sgYLo2pbX7AMQhPA-DG95FQpJG-tcW3dANFWUNG3HMGUQuABNZZiuFCWDNXWyKxctA9_g02CtqzMxNxgTHS7DQtDqf7egmxEE1vOirHwJUiz1ywH_M6ZUAj0d4aSKxnOA4BjqQhX1z39gwu33B_5cHfAdWjWOcMgUJziI_1RrYsDxcuQE3ZJhOZuhu1iAkmDlnExd-oms4fMiG5DfKipUcjxOtRT1oR3_bzs9VgcDQ_eVngoVd958FTwO-xysGwIb0rsu_PoKM1SzhlyG1zbgZml8EXsdQ1E6oDJzcN4m4LCaeKalAaux2mOyY2Db4DX0AIMH_LSPODviM2yiZRJDTYwjsarnAKxrNZFuiQ62VA7e9JVbgnhxEfsuz16Ky48xRQzoESdJo6Ds6teb58Myh0AqSgTz6-65n61jV4m9oqVsVBEMU7n3Cr-Bo5dT-vzY8swAkLrpeqJrTiuYPiK5pbLqx_TZ_EOvDXAdG7YbERdxKudLEOFUhYDQeo01WupvzmRLKfA3Zun_OFi4G2ze0G9NzEMzATusrIv3Ebvx8Nc5RNZ6_HSRkcXlwnUUpl08NMtG10eXmAwpcKfmo--9QMW_n1XaW5pkEAErOSZqfERF-4weIoiTw7xNg9zixap5qpxS_-rF8LyBM_oxUjadHil3KUTgf0QfuD63e5OmwVaShst16I2aPU69QrUGrBvqv5Ss_udTjis865vt8clIp90MRKupLcNY_dLPr_LOs1FxSE0YaydwGyRb-9PICSB6UnAOXzEDvf1q5G1nvIrNVb3x1PYY3EQqKpHWc-3Bcoiey1f_-nq7NUT8VW2DjqNgFYIU0_ZEHEvERJwlxWVW9FpP-c4_SS3JXZHuAUDqZMXa65nIhnr1k2UONsREW5mf-XW_-hqt2o68GEfKtdQg">

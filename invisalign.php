...
<section class="single-header">
        <div class="grid">
            <div class="bg-here">
                <div class="inr">
                    <div class="headings">
                        <h2 class="clr-blue3 min-b">Invisalign<sup>®</sup></h2>
                        <h1 class="clr-blue2 most-b">Explained</h1>
                    </div>
                    <div class="line"></div>
                    <p class="mb-0">Straight teeth and a beautiful smile no longer mean enduring the inconvenience of traditional metal braces. Welcome to the world of Invisalign® at Russell Street Dental Practice - a cutting-edge solution that combines advanced technology with the sheer convenience of virtually invisible aligners, letting you straighten your teeth with minimal disruption to your daily life. </p>


                </div>
            </div>
            <div class="img-div">
                <img src="assets/a-images/header (2).webp" alt="">
            </div>
        </div>
    </section>
        ...
        <div class="wrap">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="headings">
                            <h3 class="clr-blue3 min-b">What is </h3>
                            <h2 class="clr-blue2 most-b">Invisalign<sup>®</sup> ?</h2>
                        </div>
                        <p>Invisalign<sup>®</sup> is an orthodontic system that utilises a series of clear, custom-fit aligners, designed
                            specifically for your teeth. Made from a proprietary, virtually invisible, medical-grade thermoplastic,
                            Invisalign<sup>®</sup> aligners are not only aesthetically pleasing but also comfortable. They gently and gradually
                            shift your teeth into the desired position, based on the precise movements that your dentist plans out for you.</p>
                        <p>One of the biggest benefits of Invisalign<sup>®</sup> is its flexibility. The aligners are removable, meaning you can eat, drink, brush and floss with ease. It’s a system that fits seamlessly into your lifestyle and requires fewer visits to the dentist compared to traditional braces. </p>
                        <p>With 3D imaging technology, Invisalign<sup>®</sup> allows you to visualise the outcome even before the treatment starts. This bespoke approach to orthodontics ensures you get a smile that's not just straighter, but tailored specifically to enhance your facial aesthetics. </p>
                        <div class="demo-gallery">
                            <ul id="lightgallery">
                                <li data-responsive="https://sachinchoolur.github.io/lightgallery.js/static/img/1-375.jpg 375,
                                 https://sachinchoolur.github.io/lightgallery.js/static/img/1-480.jpg 480,
                                  https://sachinchoolur.github.io/lightgallery.js/static/img/1.jpg 800"
                                   data-src="assets/a-images/single-o (1).webp" data-lg-id="538fab33-6de9-47e6-878d-ff4729309b98">
                                    <a href="">
                                        <img class="img-responsive" src="assets/a-images/single-o (1).webp">
                                ...
                                https://sachinchoolur.github.io/lightgallery.js/static/img/2-480.jpg 480,
                                 ...
                                 data-src="assets/a-images/single-two (1).webp" data-lg-id="b02e4f79-2aea-43eb-89bb-7878d3448128">
                                    <a href="">
                                        <img class="img-responsive" src="assets/a-images/single-two (1).webp">
                                        <div class="demo-gallery-poster">
                                            <img src="https://sachinchoolur.github.io/lightgallery.js/static/img/zoom.png">
                                        </div>
                                    </a>
                                ...
                                <li data-responsive="https://sachinchoolur.github.io/lightgallery.js/static/img/13-375.jpg 375,
                                 ...
                                 data-src="assets/a-images/single-three (1).webp" data-lg-id="0f8263e2-f36d-46b4-82d5-46213c94c182">
                                    <a href="">
                                        <img class="img-responsive" src="assets/a-images/single-three (1).webp">
                                        <div class="demo-gallery-poster">
                                            <img src="https://sachinchoolur.github.io/lightgallery.js/static/img/zoom.png">
                                        </div>
                                    </a>
                        ...
                        <p>Invisalign<sup>®</sup> is suitable for most people - from teenagers with erupting or erupted permanent dentition to adults who wish to improve their smiles without compromising their appearance or lifestyle during treatment. </p>
                        <div class="line"></div>
                      
                        <div class="row">
                            <div class="col-lg-7">
                                <p>At our dental practice, we take great pride in helping our patients achieve their perfect smile. We are fully trained and experienced in providing Invisalign<sup>®</sup> treatments, working with you to design a personalised treatment plan that delivers the results you want. </p>
                                <p>Begin your journey to a brighter, straighter smile today with Invisalign<sup>®</sup>. Get in touch to discover how simple and easy the process can be, and step into a new era of orthodontics with us.</p>
                            </div>
                            <div class="col-lg-5">
    ...
    <div class="cal-mail d-flex align-items-center gap-2">
        ...
        <form action="" class="needs-validation" id="contactForm">
            ...
            <div class="col-md-12 mb-3 d-flex justify-content-center">
                ...
                <input type="hidden" id="g-recaptcha-response" name="g-recaptcha-response" value="0cAFcWeA4nc_Y0yeceRIoxDFeszeQff0rpLW1h_KVHnhSnthuGWu9AlhZmyBgtpJCxdEZ2nBlIuGzmEeLT9rnJpA_DXBVbui0GBJV0lWYnsIE-AECnWOp6ij_eLH5hrpXYr7AvlXg36k6f0lvPtI_lhDtBvKQMP0aHj42LiwYJTBn8R6zk1uAVWkeLKGUWG7JrQjQmFHFzaabRD2drrkjS8E0TIhUjPmX7_MIvELcU48cJjYih7adVRNdJWxpGZ0Mbkcm2aSoCZ1XG6ZZzyHs5paV8WdN0PEmeiaT-Yp1r0dxffyE_ySP34qGxfjSCpNWUPICAp3Uu_I75tK5ZnTmCcChA7JRI79hXbDHGVAUYanuZ5bVA5fe-qtr_ikTRIOIntIxfvQ_g0FDCJkyYVM_wGCJRvu4KgykMGBATP9UBm4umAEMluu9BWTTb_uFR9ox7QkaGS53vaUdcnz1ejfEJW4PvQVNnfNWPG8cwrFgv67iw-XOBJhmYZeI2mkcbRwALQjaNYN1lG9MjDXoZnFTdq2gDW_1rdcj8MDQwSkObyA-tBkK5Cx1cQw94jhlERb-K1o-eQ1xVbT9dKCNhIoa28xxnTfTDdhXAxqaC6HfmFtCirkGMSSIUMlRyFIyLjbFSCkyh2BLVU1DcrfjYYJgyW7zJlXZ6Cx50QY_lM8oFak9UnLTLQ2StZHff2k8OizZ1kMDc1CQsNMdVgq9Swmem-b2X29ShCDjGqSiJIGKyHphwAuc6IqILTKjHjpdgmWYzKtxp0Ou_dBueORfeorPUPhjN5IpDEdGI7G8WsrKCd9Kzjyx_pv7aQ-JuyozfRs5wKGZJhKiNZ4qUBjRLRqjJTTb28RWcCQLGpwJ3YcXXdGyMvX_ceBm-GrHdNVw5J4pEyJwkKRXB_NcZXINXdgFy_ujJO5-7klbW9FcHDDaOSo0ST3KMV0CVbrFfnPJEOZzpxtX-_dueO6sKzjZiHtiJ-DnG_o1fgS88Y7mOApIVMftWtGNKqfrDD2TBZ2T02ISRgJBW0CUhwwswuspQtEogUzM2_IdZbWuZuh56jUtvwGqbpWC0eW3IR5b5L_8XFAxuen5wRsXv-7n9J3BS_EnMowUmrKijmuPlUdaCMohBCuk4VVPJO1CL2wD0cjhtnohIffAgdTYrstUQKK5sk1dxvweNwKOrDx07UKSCaO18sYlXnna-uWL6XOJYw6csaL65Vqh7hUbdvXwmpUj3HTCNYNYH4Mf4ykWTmtoPNRgzPVvbtohh6Nf4ggJh9aQbs1tfv7Vv6zuDYR8LsQpLKA3Vyu_lSR3_kspnupyTqr5LT3XenemCaO02cAdRVDZkPxTIM9GpHIVRb815dK1W0o2RmnNeckDzdz0fjioOErjye7um5dRzwMBKeK2ttd3m9z_GVcWPGwvQahT6pLCK9b1j37fRGwFIbQkPFb1Vwp7ZtjDYJYCRZpZdKmhZwxRblZuQVbiKb0lTQsEr6KscFBilQypIDj6qkz5_icB3W9FUGrtCBNupIP-L8KlWyPp7RpWYmtHgFQLOoFyzYk64YjwbU_0QNDO3ewOgv3UariP2SA-EzTIuE1BOK1tYkmckpO2g8BJr9kxaMoJC">
...
<!-- 4 -->
 ...
 <section class="smile-view">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <h3 class="sub-title6 text-center font-weight-sbold text-secondary1"><span class="text-primary1">Invisalign<sup>®</sup> </span> Smile View</h3>
                    <p class="text-center upr-para">With the Invisalign Smile View you can quickly and easily see how you’d look with a new smile so give it a try – it takes literally minutes! ‌</p>
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6 mb-lg-0 mb-3">
                            <img src="assets/a-images/phone.jpg" alt="Phone">
                        </div>
                        <div class="col-12 col-lg-6 ">
                            <div class="row">
                                <div class="col-6 ">
                                    <img src="assets/a-images/before-phone.jpg" alt="Before" class="rounded-circle">
                                    <p class="mt-3 text-center"><strong>Before</strong></p>
                                </div>
                                <div class="col-6">
                                    <img src="assets/a-images/after-phone.jpg" alt="After" class="rounded-circle">
                                    <p class="mt-3 text-center"><strong>After</strong></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- 5 -->
 <section class="invis-works">
        <h3 class="sub-title6 text-center font-weight-sbold text-secondary1 container-fluid"><span class="text-primary1">How</span> Invisalign<sup>®</sup> works</h3>
        <div class="row">
            <div class="col-lg-6 p-0">
                <div class="video-container" id="video-container-1">
                    <video controls="" id="video" preload="metadata" poster="assets/a-images/VIDEO_ONE_POSTER.webp">
                        <source src="assets/a-images/INVIS1.mp4" type="video/mp4">
                    </video>
            ...
            <div class="col-lg-6 p-0">
                <div class="video-container" id="video-container-2">
                    <video controls="" id="video1" preload="metadata" poster="assets/a-images/VIDEO_2_POSTER.webp">
                    ...
                    <div class="play-button-wrapper">
                        <div title="Play video1" class="play-gif" id="circle-play-b1">
                            <!-- SVG Play Button -->
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80">
                                <path d="M40 0a40 40 0 1040 40A40 40 0 0040 0zM26 61.56V18.44L64 40z"></path>
                            </svg>
...
<section class="invis-steps">
        <div class="container">

            <h3 class="sub-title3 text-center font-weight-sbold text-secondary1 upr"><span class="text-primary1">5 steps</span> to your new smile.</h3>
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="img-div">
                        <img src="assets/a-images/step-img1.png" alt="">
                    </div>
                    <h3 class="sub-title2 text-secondary1 ">Step <span class="text-primary1">1</span></h3>
                    <p><strong>FREE Invisalign<sup>®</sup> Consultation with Russell Street Dental </strong></p>
                    <div class="text-small">
                        Kick start your teeth straightening journey with a complimentary, no obligation consultation with Russell Street dental practice. This appointment is very relaxed and will allow us to discuss your
                        concerns and how you may benefit from Invisalign<sup>®</sup>. This initial consultation can be face to face or
                        virtual.
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="img-div">
                        <img src="assets/a-images/step-img2.png" alt="">
                    </div>
                    <h3 class="sub-title2 text-secondary1 ">Step <span class="text-primary1">2</span></h3>
                    <p><strong>Treatment Outcome Simulation</strong></p>
                    <div class="text-small">
                        Russell Street dental practice team will carry out a free digital scan treatment simulation to show you how
                        Invisalign<sup>®</sup> could transform your smile.
                        .</div>
                </div>
                <div class="col-md-6">
                    <div class="img-div">
                        <img src="assets/a-images/step-img3.png" alt="">
                    </div>
                    <h3 class="sub-title2 text-secondary1 ">Step <span class="text-primary1">3</span></h3>
                    <p><strong>Review of Oral Health</strong></p>
                    <div class="text-small">
                        Once the treatment goals have been agreed you will go through a full clinical examination to make
                        sure you are dentally fit prior to starting your Invisalign<sup>®</sup> journey. This ensures there are no
                        underlying problems that could impact the outcome of your smile - remember has to be healthy as well
                        as aesthetically pleasing.
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="img-div">
                        <img src="assets/a-images/step-img4.png" alt="">
                    </div>
                    <h3 class="sub-title2 text-secondary1 ">Step <span class="text-primary1">4</span></h3>
                    <p><strong>Start your Invisalign<sup>®</sup> journey</strong></p>
                    <div class="text-small">
                        Once your aligners have been delivered, Russell Street dental practice team will invite you back in to fit your first set of
                        aligners and run through how to look after them. You'll usually be seen every 4-8 weeks to ensure
                        you are on track and given your next set of aligners.
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="img-div">
                        <img src="assets/a-images/step-img5.png" alt="">
                    </div>
                    <h3 class="sub-title2 text-secondary1 ">Step <span class="text-primary1">5</span></h3>
                    <p><strong>Enjoy your straight teeth and smile with confidence</strong></p>
                    <div class="text-small">
                        Well done! You're at the end of your treatment. When you get to the end of the treatment you'll have
                        a final scan to create your retainers. You will also receive your FREE whitening kit so you'll be
                        all set to enjoy your beautiful new smile!
                    </div>
                </div>
            </div>
        </div>

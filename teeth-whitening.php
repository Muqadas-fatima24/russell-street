     ...
     <section class="single-header">
        <div class="grid">
            <div class="bg-here">
                <div class="inr">
                    <div class="headings">
                        <h2 class="clr-blue3 min-b">Teeth</h2>
                        <h1 class="clr-blue2 most-b">Whitening</h1>
                    </div>
                    <!--                    <h3 class="clr-blue3">Elevate Your Smile to Radiant Perfection</h3>-->
                    <div class="line"></div>
                    <p>At Russell Street Dental we believe that a bright, confident smile can light up your world. Our whitening service is designed to help you achieve the dazzling smile you've always dreamed of. Say goodbye to stains and discoloration, and say hello to a whiter, more radiant you.</p>
                </div>
            </div>
            <div class="img-div">
                <img src="assets/a-images/header (6).webp" alt="">
                <!--                <div class="center-div">-->
                <!--                    <div class="content">-->
                <!--                        <div class="upr-o"></div>-->
                <!--                        <div class="bot-o"></div>-->
                <!--                        <p class="text-center">"DentiCare was founded in the first place to create absolutely beautiful smiles."</p>-->
                <!--                    </div>-->
                <!--                </div>-->
            </div>
        </div>
        ...
        <div class="wrap">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="headings">
                            <h3 class="clr-blue3 min-b">Why Choose Professional</h3>
                            <h2 class="clr-blue2 most-b">Teeth Whitening?</h2>
                        </div>
                        <ul>
                            <li><b class="clr-blue3 ">How does it work? </b> Teeth whitening uses bleaching gels to break down stains on your teeth to make them appear whiter. You place the gels in custom trays and usually wear them overnight so they can work while you sleep.</li>
                            <li><b class="clr-blue3 ">Does it hurt? </b> Teeth whitening is a comfortable procedure for most people with no pain but some patients can experience temporary tooth sensitivity during treatment.</li>
                            <li><b class="clr-blue3 ">How long does it last? </b> This depends largely on your diet and oral hygiene. Some patients go years without whitening again, others like to ‘top up’ their whitening every few months.</li>
                            <li><b class="clr-blue3 ">Would I be suitable? </b> Probably yes, as long as you have no active disease in your mouth or allergies to the gels, you’d be suitable for whitening but we’d need to do a full examiniation first.</li>
                            <li><b class="clr-blue3 ">It’s cheaper online, why? </b> You can find cheaper whitening online but they don’t contain the active ingredient needed to actually whiten your teeth – remember only dentists are legally allowed to provide teeth whitening.</li>
                        </ul>
                        <div class="demo-gallery">
                            <ul id="lightgallery">
                                ...
                                data-src="assets/a-images/single-o (4).webp" data-lg-id="f4e78522-355e-4c1f-9bbc-d0e401303950">
                                    <a href="">
                                        <img class="img-responsive" src="assets/a-images/single-o (4).webp">
                                ...
                                data-src="assets/a-images/single-two (4).webp" data-lg-id="39f50787-3df8-48ce-b936-e105c33b9d7e">
                                    <a href="">
                                        <img class="img-responsive" src="assets/a-images/single-two (4).webp">
                                        <div class="demo-gallery-poster">
                                            <img src="https://sachinchoolur.github.io/lightgallery.js/static/img/zoom.png">
                                        </div>
                                    </a>
                                ...
                                data-src="assets/a-images/single-three (4).webp" data-lg-id="e84adc68-616c-47f0-a6ba-b703a5108329">
                                    <a href="">
                                        <img class="img-responsive" src="assets/a-images/single-three (4).webp">
                                        <div class="demo-gallery-poster">
                                            <img src="https://sachinchoolur.github.io/lightgallery.js/static/img/zoom.png">
                                        </div>
                                    </a>
                        ...
                        <div class="row ">
                            <div class="col-lg-7">
                                ...
                                <!-- <p>If you have tooth decay or receding gums, whitening may make your teeth sensitive. Whitening also does not work on ceramic or porcelain crowns or veneers.</p> -->
                                <!-- <p>We take a personalised approach to your needs, offering a range of services. In addition to general and cosmetic dentistry, our Dental Clinic in Leek also can assist in:</p> -->
                                <h3 class="clr-blue3 min-b" style="font-size: 24px;">The Teeth Whitening Procedure</h3>
                                <p>During your visit, we will carefully assess the best teeth whitening option for you and take a scan of your teeth so we can order custom made trays to fit your teeth. Once the trays are delivered, you would need to come back in to collect them along with your whitening gels where a member of our team will show you how to use them. The procedure is painless and typically takes around two weeks, depending on the level of discoloration.</p>
                            </div>
                        ...
                        <h3 class="clr-blue3 min-b" style="font-size: 24px;">Maintaining Your Radiant Smile</h3>
                        <p>As part of your teeth whitening treatment, we'll provide you with tips and advice on maintaining your new, radiant smile. Good oral hygiene practices, along with regular dental check-ups, will help extend the longevity of your teeth whitening results.</p>
                        <h3 class="clr-blue3 min-b" style="font-size: 24px;">Book Your Whitening Appointment Today</h3>
                        <p>Ready to unlock the potential of your smile? Schedule your whitening appointment with Russell Street Dental today. Our team of skilled professionals is eager to help you achieve the stunning smile you deserve.</p>
                    </div>
                    <div class="col-lg-5">
    ...
    <div class="cal-mail d-flex align-items-center gap-2">
        ...
        <form action="" class="needs-validation" id="contactForm">
            ...
            <div class="col-md-12 mb-3 d-flex justify-content-center">
                ...
                <input type="hidden" id="g-recaptcha-response" name="g-recaptcha-response" value="0cAFcWeA5w7Cj25x-g423ctNddKyw3nuWOebsRPjrUY7KrELkLr4HpyP0Hj423BH1xnF2OXYnARCXDLqSR9k57IAG7zbSr-KL3RybziEMiPPY-6QNZwL4hXlrfORpaDAGLi696c2WS9t6VHdT75XdEVwr8pr9FEUEmAMoWnpzw0IjYUTGgYlGn94OJkCCcXsPksS93hbVNAVBubAQupCKvtL0jyWaw-MVPiv-pYJofREd-HTs0zirQn1QYSjmkH2unAYOSP1_eZVmr1wO7Pj1vge0Hib49s5sXEswmh3o6aHpi3yl6pjznYzujtoPiZ-UEzl2nLEa9n_SpBhny_52f18GzWfdclHIYAj5CpkntIyZHm0r6EVMW9FVYvRhsaBfjKV_CnZcIb6-neCKtrsAq6Gd-W-28i3F0ZoJOgWoUxVGe07M8bF7onodAMzDoXHcHPDuBndwr4aIvjplcyiEcYdzI61Op6ziTx4RltANeztSeumjln6hbYIwCiVJ-fEtJKn5UkEfdZkIy8DWpwi2xhYGMqlrP78uvB25RTtjmLPgNnUakt_yy6TBfGfqvNjKKHJI0-ZwYIgsTjogOJ3oBaXJkQJpK926rfGls8X7mspv2_9ZN67fhiwne8ylIhjyywUJjl1aKNTDsmFiHVbVTuG0j9jtJW-tjVcZjJkSX5cZcH12zKTwpLz4ob8xXJVBquEM8eXtiUEqi-5Q18puDTbEVGDnwjAns48WKpFiXBKL1C90ibxhE4KpTbRuxrvltisThLyjQcaVt8UjSTI42udPX2RfAywdtkbSoLFZ7HcZDQkyKVOG6yaaFUxKueGgfaVgTtioKgBXVHKCmmY7nPySPccsfI_JYDcH_hSScQD1vLYj1HhscsSKR6oWrmw5yeeAYEHNCWdOH2Jjko7RHfpvbjrFdjxeJAJ2eI6DgoWGXDivOVIcOrQ_A_BC5ksbzYeb8BXgo_Jizuqu0kNQLmvce2SC70sXrrxEhTSwoqL4pOr06ErqcD7ox-Cr6Iy37zmY57kVO0Lc0S4tc3UGxN3-lI0bsmR1H1Dg7NaVLd8nWvdiSuWNG2nOYJXVLJDOstuy5CJmA0jOiJ027weYKtNSt0-QyjfsibQhyQaemd_i-M6a8DXas7hcWBq_anxw--aZdlJBhNtah8KkVTYMbnRQCqW4WvvvfpBBpsxbJHGMF9t4KyICSCgI5t2h-jbUhepYNJVaAuw_MpDhc5wmwZV181XXdg-tObz_EOH_z41vcEhkwq13F6pQSaGiEW8_jTHL361LYRTV8bjPtzCR4OzWYsrR6ilUcyLQLqdTc49x71g4JR-UF9hUwCUr-7no9uUI8qSwEVEPqGizEja9DKFSW8lrqwGu4ZdOhZX1MEi6fFJn4bhi5E4vjhQzM-dlTLFPUFhmpeQig6IgpSItClGkYPJCF2E5MuL-sLRwbDCtqJyPCXU9JLxw7pbihxO7ndsjbCZS6b_k9mO-6s8_eldjLhXvrFScp-IIsTkRJg9XG0pK9AbMwxmAtM2PWPcN7OXKkspypIbSTnDMCM1gUB9ClRHATMnQNjrWgFOTrYdmRhXe-_bBQlyQ_s9cZ0kJm3T80H80t48Dt_NVA0ZQl0sOcKvMyb6nYjDII_L97ihazngyzGaGZ-Ck">
